<template>
  <div class="flex items-center justify-center w-screen">
    <div class="w-full max-w-lg p-4 space-y-4 bg-gray-900 rounded-lg shadow-xl">
      <StocksDropdown />
      ...
      <div class="flex">
        <button
          v-wave
          class="flex items-center justify-center w-full py-4 font-semibold text-purple-300 bg-purple-800 rounded-lg  text-md sm:focus:shadow-outline-indigo hover:bg-purple-900 focus:outline-none"
          @click.prevent="show"
        >
...
export default {
  components: { StocksDropdown, CloudIcon, CurrencyDollarIcon, CalendarIcon },
  setup() {
    init();
